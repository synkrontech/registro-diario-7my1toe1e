-- Replace the notification trigger function to handle different table structures safely
-- This fixes the runtime error when inserting into audit_logs which doesn't have an email column
